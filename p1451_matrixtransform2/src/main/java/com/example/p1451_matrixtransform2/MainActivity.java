...
//            super.onDraw(canvas);
            ...
            canvas.drawLine(src[0],src[1],src[4],src[4],pGray);
            ...
            canvas.drawPath(pathDst,p);
            canvas.drawLine(dst[0],dst2[1],dst2[2],dst2[3],pBlack);
            canvas.drawLine(dst[0],dst2[1],dst2[4],dst2[5],pGray);
            canvas.drawLine(dst[0],dst2[1],dst2[6],dst2[7],pWhite);
        }
    }
